...
using CarCommun.Core.Models.Account;
using CarCommun.Core.Services;
using CarCommun.Core.Services.Account;
using CarCommun.Core.Services.Shop;
using CarCommun.Server.Authorization;
using CarCommun.Server.Authorization.Requirements;
using CarCommun.Server.Configuration;
using CarCommun.Server.Services;
using CarCommun.Server.Services.Email;
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.DocumentTitle = "Swagger UI - CarCommun";
